...
import { logSiginQr, SiginQrDto, SigninResultDto } from '../../user/auth/dto/signin-qr.dto';
...
export class SocketService {
    ...
    async signinQrResult(targetSocketId: string, data: SigninResultDto): Promise<void> {
