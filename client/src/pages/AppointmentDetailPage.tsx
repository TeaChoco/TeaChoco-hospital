//-Path: "TeaChoco-Hospital/client/src/pages/AppointmentDetailPage.tsx"
import React, { useMemo } from 'react';
import { mockAppointments } from '../mocks/data';
import { useParams, useNavigate } from 'react-router-dom';
import { FaArrowLeft, FaUserMd, FaHospital, FaNotesMedical, FaStethoscope } from 'react-icons/fa';

export const AppointmentDetailPage: React.FC = () => {
    const { id } = useParams<{ id: string }>();
    const navigate = useNavigate();

    const appointment = useMemo(() => mockAppointments.find((a) => a._id === id), [id]);
