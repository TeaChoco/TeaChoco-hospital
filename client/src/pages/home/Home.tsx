...
export default function Home() {
    ...
    return (
        <div className="space-y-128 pb-32 overflow-x-hidden min-h-screen relative">
            {/* --- Hero Section --- */}
                            ...
                            <div className="space-y-10">
                                ...
                                <div className="flex gap-8 items-center pt-4">
                                    <div className="text-center">
                                        ...
                                        <div className="text-xs font-black uppercase tracking-widest text-text-light/40 dark:text-text-dark/40 mt-1">
                                            Secure
                                        </div>
                                    </div>
            ...
            {/* --- Usage Guide --- */}
            <ScrollReveal direction="scale" duration={900} delay={100}>
            ...
            {/* --- Tech Stack --- */}
            <ScrollReveal direction="fade" duration={800} delay={150}>
