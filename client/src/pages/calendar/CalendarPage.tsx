    ...
    return (
        <div className="h-[calc(100vh-100px)] flex flex-col gap-4">
            <ListLayout
                ...
                <div className="flex-1 bg-bg-card-light dark:bg-bg-card-dark p-4 rounded-xl shadow-sm border border-border-light dark:border-border-dark text-text-light dark:text-text-dark transition-all duration-200">
                    <Calendar
                        events={events}
                        onSelectEvent={(event) => {
