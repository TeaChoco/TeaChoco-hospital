        ...
        <div className="min-h-screen flex flex-col items-center justify-center p-6 text-center">
            <div className="max-w-4xl w-full space-y-8 animate-fade-in-up">
                ...
                <p className="text-xl text-text-secondary-light dark:text-text-secondary-dark max-w-2xl mx-auto leading-relaxed">
                    Experience modern healthcare management with a touch of
                    elegance. Secure, fast, and user-friendly.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16 text-left">
                    <div className="card">
                        ...
                        <p className="text-text-muted-light dark:text-text-muted-dark">
                            Efficient patient tracking and hospital resource
                            optimization using AI-driven insights.
                        </p>
                    </div>
                    <div className="card">
                        ...
                        <p className="text-text-muted-light dark:text-text-muted-dark">
                            Enterprise-grade security with multi-factor
                    ...
                    <div className="card">
                        ...
                        <p className="text-text-muted-light dark:text-text-muted-dark">
                            Round-the-clock technical support to ensure your
                            hospital operations never stop.
                        </p>
                    </div>
                </div>
            </div>
